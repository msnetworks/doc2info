...
<table class="table table-bordered" style="border: 2px solid #000; width: 100%; table-layout: fixed;">
    <tbody>
        ...
        <!-- Case Details -->
        <tr style="border: 2px solid #000;">
            <td style="border: 2px solid #000; text-align: center;" colspan="2">{{ $case->getCase->getBank->name ?? null }} <br> {{ optional($case->getFiType)->name }}</strong></td>
        </tr>
        <tr style="border: 2px solid #000;">
        ...
        @if($case->fi_type_id === 13 || $case->fi_type_id === 45)
            <tr style="border: 2px solid #000;">
                <td style="border: 2px solid #000;">Company Name</td>
                <td style="border: 2px solid #000;">{{ $case->company_name ?? 'N/A' }}</td>
            </tr>
            <tr style="border: 2px solid #000;">
